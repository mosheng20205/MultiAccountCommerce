...
namespace EmojiWindowEcommerceWorkspaceSketchDemo
{
    internal sealed partial class EcommerceWorkspaceSketchApp
    {
        ...
        private const int InfoMainFontSize = 15;
        private const int InfoSubFontSize = 14;
        ...
        private void ApplyTheme()
        {
            ...
            EmojiWindowNative.SetLabelFont(_lblGroupListTitle, _fontYaHei, _fontYaHei.Length, Scale(18), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblGroupEditorTitle, _fontYaHei, _fontYaHei.Length, Scale(18), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblGroupNameCaption, _fontYaHei, _fontYaHei.Length, Scale(15), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblGroupUrlCaption, _fontYaHei, _fontYaHei.Length, Scale(15), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblGroupStats, _fontYaHei, _fontYaHei.Length, Scale(15), 0, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblGroupHint, _fontYaHei, _fontYaHei.Length, Scale(15), 0, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblProxyListTitle, _fontYaHei, _fontYaHei.Length, Scale(18), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblProxyEditorTitle, _fontYaHei, _fontYaHei.Length, Scale(18), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblProxyNameCaption, _fontYaHei, _fontYaHei.Length, Scale(15), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblProxyTypeCaption, _fontYaHei, _fontYaHei.Length, Scale(15), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblProxyHostCaption, _fontYaHei, _fontYaHei.Length, Scale(15), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblProxyPortCaption, _fontYaHei, _fontYaHei.Length, Scale(15), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblProxyUserCaption, _fontYaHei, _fontYaHei.Length, Scale(15), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblProxyPasswordCaption, _fontYaHei, _fontYaHei.Length, Scale(15), 1, 0, 0);
            EmojiWindowNative.SetLabelFont(_lblProxyHint, _fontYaHei, _fontYaHei.Length, Scale(15), 0, 0, 0);
            ...
            EmojiWindowNative.SetEditBoxColor(_editProxySearch, text, dark ? Argb(255, 26, 30, 36) : Argb(255, 255, 255, 255));
            EmojiWindowNative.SetEditBoxColor(_editProxyQuickImport, text, dark ? Argb(255, 26, 30, 36) : Argb(255, 255, 255, 255));
            ...
            EmojiWindowNative.SetEditBoxFont(_editProxySearch, _fontSegoe, _fontSegoe.Length, Scale(EditFontSize), 0, 0, 0);
            EmojiWindowNative.SetEditBoxFont(_editProxyQuickImport, _fontSegoe, _fontSegoe.Length, Scale(EditFontSize), 0, 0, 0);
